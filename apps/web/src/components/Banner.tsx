...
export const Banner = ({ message }: BannerProps) => (
  <div className="relative isolate flex items-center gap-x-6 overflow-hidden w-full bg-gray-900 text-white py-1 px-6 sm:px-3.5 justify-center">
    <svg
      viewBox="0 0 577 310"
      aria-hidden="true"
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <stop offset={1} stopColor="#ff0400" />
        </linearGradient>
      </defs>
    </svg>
    <svg
    ...
    <div className="flex flex-wrap items-center justify-center gap-y-2 gap-x-4">
      <p className="text-sm leading-6 text-white uppercase">
        <strong className="font-semibold">Anyon</strong>
        {/* <svg
          viewBox="0 0 2 2"
