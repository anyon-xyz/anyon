...
const Home: NextPage = () => {
  const {
    ...
    showSteamLinkModal: state.showSteamLinkModal,
  ...
  return (
    <>
      ...
      <Container>
        ...
        {selectItemToWrap && openWrapModal ? (
          <Wrap item={selectItemToWrap} />
        ) : null}

        {showSteamLinkModal ? <LinkSteamModal /> : null}
